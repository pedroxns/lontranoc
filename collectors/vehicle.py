"""Legacy launcher for the Home Assistant vehicle provider.

Temporary entrypoint used by the existing systemd service.
"""

from otterpilot.capabilities.vehicle.providers.homeassistant import main
